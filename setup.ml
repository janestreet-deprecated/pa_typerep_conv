(* OASIS_START *)
(* DO NOT EDIT (digest: 33a11546b66cc0ebc25c69ad81f8a810) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/pa_typerep_conv";
          synopsis = "Runtime types for OCaml";
          description =
            Some
              [
                 OASISText.Para
                   "Library for creating runtime representation of OCaml types and computing functions from these."
              ];
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\028&\128\218\177\146\241\156\165B\196\174\185\140\231\188";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
